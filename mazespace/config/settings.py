...
GRID_SETTINGS = {
    ...
    "obstacle_prob_lava": 0.35  # Lava maze
}
...
THEME_SETTINGS = {
    ...
    "LAVA": {
        "name": "Lava Maze",
        "bg_color": (0.1, 0.05, 0.0, 1.0),  # Dark red background
        "fog_enabled": True,
        "fog_color": (0.3, 0.1, 0.05),      # Orange fog
        "fog_density": 0.025,
        "particles_enabled": True,
        "audio_enabled": True,
        # Lava specific settings
        "lava_coverage": 0.12,              # Lava coverage ratio
        "lava_damage": 10.0,                # Lava damage
        "health_start": 100.0               # Initial health
    }
}
...
LAVA_SETTINGS = {
    "agent_colors": {
        ...
        "mini_drone": (1.0, 0.3, 0.0),     # Light Orange
